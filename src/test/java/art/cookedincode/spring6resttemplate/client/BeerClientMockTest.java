...
import art.cookedincode.spring6resttemplate.config.OAuth2ClientInterceptor;
import art.cookedincode.spring6resttemplate.config.RestTemplateBuilderConfig;
import art.cookedincode.spring6resttemplate.model.BeerDTO;
import art.cookedincode.spring6resttemplate.model.BeerDTOPageImpl;
...
public class BeerClientMockTest {
    ...
    public static class TestConfig {
        ...
        @Bean
        OAuth2ClientInterceptor oAuth2ClientInterceptor(OAuth2AuthorizedClientManager manager, ClientRegistrationRepository clientRegistrationRepository) {
    ...
    void testGetBeerById() {
        ...
        assertEquals(dto.getId(), beerById.getId());
    }
